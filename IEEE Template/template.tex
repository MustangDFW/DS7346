...
\bibitem{c21} @misc{nasaExoplanetArchive, title={About the NASA Exoplanet Archive}, url={https://exoplanetarchive.ipac.caltech.edu/docs/intro.html}, journal={NASA Exoplanet Archive Overview and Holdings}} 
